...
var author$project$Main$init = function () {
	...
	var controlPanel = {button: './static/src/rcs/r_arrow.png', margin: '0px', maxHeight: '', status: author$project$Main$Open};
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Control':
				...
				if (_n1.$ === 'Open') {
					var controlPanel = {button: './static/src/rcs/sum.png', margin: '-320px', maxHeight: '', status: author$project$Main$Close};
					return _Utils_Tuple2(
						_Utils_update(
							model,
			...
			case 'History':
				...
				if (_n2.$ === 'Open') {
					...
					var historyPanel = {button: './static/src/rcs/down.png', margin: '0px', maxHeight: 'calc(100vh - 195px)', status: author$project$Main$Open};
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{historyPanel: historyPanel}),
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$Attributes$src(model.controlPanel.button),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2(elm$html$Html$Attributes$style, 'height', '128px'),
						A2(elm$html$Html$Attributes$style, 'width', '100%'),
